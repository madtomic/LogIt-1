...
public final class MailSender
{
	 ...
	 * 
	 * @param to
	 *            a collection of recipient addresses to which the mail will be sent.
	 * @param from
	 *            the sender address.
	 * @param subject
	 *            the mail subject.
	 ...
	 *            the mail body.
	 * @param html
	 *            whether HTML should be enabled in this mail.
	 * @throws MessagingException
	 *             if an error occurred.
	 */
	public void sendMail(Collection<String> to, String from, String subject,
			String body, boolean html) throws MessagingException
	{
	...
	public static MailSender from(String host, int port, String user,
			String password)
	{

		...
		ConfigurationSerializable
{
	...
	public String toString()
	{
		return "world: " + world + "; x: "
				+ new BigDecimal(x).setScale(2, RoundingMode.HALF_UP) + "; y: "
				+ new BigDecimal(y).setScale(2, RoundingMode.HALF_UP) + "; z: "
				+ new BigDecimal(z).setScale(2, RoundingMode.HALF_UP)
				+ "; yaw: "
				+ new BigDecimal(yaw).setScale(2, RoundingMode.HALF_UP)
				+ "; pitch: "
	...
	public static LocationSerializable fromBukkitLocation(

...
{
	PLAIN("plain"), MD2("md2"), MD5("md5"), SHA1("sha-1"), SHA256("sha-256"), SHA384(
			"sha-384"), SHA512("sha-512"), WHIRLPOOL("whirlpool"), BCRYPT(
			"bcrypt"), AUTHME("authme");
	 ...
	 * 
	 * @param name
	 *            string representation of a {@code HashingAlgorithm}.

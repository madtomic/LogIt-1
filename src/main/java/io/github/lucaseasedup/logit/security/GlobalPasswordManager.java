		...
		Runnable
{
	...
	public String generatePassword()
	{
		...
		long lifetimeTicks = getConfig("config.yml").getTime(
				"globalPassword.invalidateAfter", TimeUnit.TICKS);
	 ...
	 */
	public static final long TASK_PERIOD = TimeUnit.SECONDS.convert(1,
			TimeUnit.TICKS);

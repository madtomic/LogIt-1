package io.github.lucaseasedup.logit.util.com.comphenix.tinyprotocol;

import io.github.lucaseasedup.logit.util.com.comphenix.tinyprotocol.Reflection.FieldAccessor;
import io.github.lucaseasedup.logit.util.com.comphenix.tinyprotocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
	...
	private static final FieldAccessor<?> getGameProfile = Reflection.getField(PACKET_LOGIN_IN_START, Reflection.getGameProfile(), 0);
	...
	private final class PacketInterceptor extends ChannelDuplexHandler {
		...
		private void handleLoginStart(Channel channel, Object packet) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
			if (PACKET_LOGIN_IN_START.isInstance(packet)) {
				Object profile = getGameProfile.get(packet);
				channelLookup.put((String)Reflection.getGameProfile().getMethod("getName").invoke(profile), channel);
			}
		}
	}
}
...
public final class CollectionUtils
{
	...
	public static boolean containsIgnoreCase(String needle,
	 ...
	 * 
	 * @param collection
	 *            the collection to be populated with the given element.
	 * @param element
	 *            the element to be added to the given collection.
	 */
	public static <T> void addNonnullIfMissing(Collection<T> collection,
			T element)
	{
		if (collection == null)
	...
	public static boolean collectionsMatch(Collection<?> coll1,
			Collection<?> coll2)
	{

...
public final class PlayerUtils
{
	 ...
	 * 
	 * @param player
	 *            a player whose location will be checked.
	 * @param location
	 *            the location which will be compared with the player location.
	 * @param radiusX
	 *            the maximum radius on X-axis.
	 * @param radiusY
	 *            the maximum radius on Y-axis.
	 * @param radiusZ
	 *            the maximum radius on Z-axis.

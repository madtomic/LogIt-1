 ...
 */
package io.github.lucaseasedup.logit.util.it.sauronsoftware.base64;
...
public class Base64OutputStream extends OutputStream
{
	...
	protected void commit() throws IOException
	{
		if (bytecounter > 0)
		{
			...
			char b3 = (bytecounter < 2) ? Base64.pad : Base64.chars
					.charAt((buffer << 20) >>> 26);
			char b4 = (bytecounter < 3) ? Base64.pad : Base64.chars
					.charAt((buffer << 26) >>> 26);
